...
public class AirbattleConfig {
    ...
    public static void saveConfig(boolean saveCapturePoints) {
        FileConfiguration conf = Airbattle.plugin.getConfig();
        if (saveCapturePoints) conf.set("capturePoints", capturePoints);
    ...
    public static void setupConfig(FileConfiguration conf) {
